...
Testing is a traditional way to assess learner knowledge, and self-quizzes are a popular way to perform formative assessments for new ACI users. Discussed earlier, testing can be used with the Kirkpatrick model, particularly in Levels 2 and 4, for the assessment of training. Self-quizzes are fairly easy to create and administer, and are more reflective and less intimidating than a marked quiz or test. During a self-quiz, users receive immediate feedback and are able to eventually obtain the correct answer. Quizzes can be administered at different times, for example, after new users receive accounts, as a pre-assessment, or after a training session. Results can be kept for student records, and at one school, digital badges are given as a result of successfully completing a training and  taking an assessment.
